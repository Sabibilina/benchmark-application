...
The default smoke latency threshold is intentionally lenient (`K6_SMOKE_HTTP_REQ_DURATION_P95_MS=20000`) because smoke runs are correctness checks for local Docker environments. Use calibration and benchmark profiles for capacity claims.
