...
| Build Tool | Maven |
| Database | PostgreSQL |
| Messaging | Apache Kafka (producer — playlist update events) |
| Containerization | Docker |
...
| Build Tool | Maven |
| Database | ClickHouse |
| Messaging | Apache Kafka (consumer — playback events) |
...
* **Exposure:**
  * Internal service only; no public client-facing API is required.
...
| Build Tool | Maven |
| Database | MongoDB |
| Messaging | Apache Kafka (consumer — playlist update / new release events) |
| Containerization | Docker |
...
| Global State | Zustand (session, playback state, queue) |
| Server State | TanStack Query |
| HTTP Client | Axios (centralized, JWT injection + retry) |
| Forms / Validation | React Hook Form + Zod |
| Drag & Drop | dnd-kit (playlist reordering) |
