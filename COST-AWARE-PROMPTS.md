...
Use `ARCHITECTURE.md` as the sources of truth for system shape, validation requirements, and implementation technology choices. Use `SCALABILITY.md` as the source of truth for benchmark workload shape, scaling assumptions, and observability expectations. If these documents conflict, stop and report the conflict instead of guessing.
...
Use `ARCHITECTURE.md` and `SCALABILITY.md`.
...
Review the generated Session 9 output against `ARCHITECTURE.md`, `SCALABILITY.md`, and the approved Session 9 plan.
